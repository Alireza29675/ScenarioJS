...
var Node = function () {
    ...
    _createClass(Node, [{
        key: "onControlRequested",
        value: function onControlRequested(shouldTurnOn) {
        ...
        value: function addReceiver(name) {
            var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _TypeValidator.any;
            ...
            // Add Receiver
            return this.receivers[name] = new _Receiver2.default(this, name, type, callback);
        }
        ...
        key: "addBroadcaster",
        value: function addBroadcaster(name) {
            var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _TypeValidator.any;

            // Validation and Catch errors
            if (!name) return new _Report2.default({ type: 'error', message: 'Broadcaster must have a name!' });

            if (this.broadcasters[name]) return new _Report2.default({ type: 'error', message: 'Broadcaster must have a name!' });

            // Add Receiver
            return this.broadcasters[name] = new _Broadcaster2.default(this, name, type);
        }
        ...
        value: function addProperty() {
            var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { type: _TypeValidator.any };
        ...
        value: function log(message) {
            _Report2.default.log(this, message);
        }
    }, {
        key: "x",
        get: function get() {
